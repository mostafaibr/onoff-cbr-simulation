...
#this objec²t stores all response times, a response time per packet
...
proc computeResponseTime { } {
	global ns onoffSamples samples_object sumZt sumZt2 blockDuration nbBlocks globalMonitor drops
...
proc computeEquations { } {
	global sumZt sumZt2 nbBlocks drops b
